 ...
 */
const ACTIONS = {
  "send /audit-gratuit": `/audit-gratuit?/send`,
...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/audit-gratuit': never, '/blog': never, '/blog/[slug]': 'slug', '/conditions-generales-de-vente': never, '/contact': never, '/mentions-legales': never, '/projets': never, '/projets/[slug]': 'slug', '/services': never }
  SERVERS: { 'GET /manifest.json': never, 'GET /sitemap.xml': never }
  ACTIONS: { 'send /audit-gratuit': never, 'send /contact': never }
